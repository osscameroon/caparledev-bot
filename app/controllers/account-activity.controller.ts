...
class AccountActivityController {
   ...
   * @return Object
   */
  public static async challenge(req: Request, res: Response): Promise<void> {
   ...
   * @return Object
   */
  public static async registerWebhook(req: Request, res: Response): Promise<void> {
    const { url } = req.body;
   ...
   * @return Object
   */
  public static async getWebhooks(req: Request, res: Response): Promise<void> {
   ...
   * @return Object
   */
  public static async triggerWebhookChallenge(req: Request, res: Response): Promise<void> {
    const { id } = req.params;
   ...
   * @return Object
   */
  public static async deleteSubscription(req: Request, res: Response): Promise<void> {
    const { access_token, access_token_secret }: any = req.body;
